...
urlpatterns = [
    ...
    path('admin/analytics/analyticssnapshot/', RedirectView.as_view(url='/accounts/admin/'), name='admin_analytics_redirect'),
    path('admin/analytics/', RedirectView.as_view(url='/accounts/admin/'), name='admin_analytics_index_redirect'),
    path('admin/', RedirectView.as_view(url='/accounts/admin/'), name='admin_index_redirect'),
