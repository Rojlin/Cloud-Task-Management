...
class AnalyticsSnapshot(models.Model):
    ...
    """
    project = models.ForeignKey(Project, on_delete=models.CASCADE, related_name='analytics_snapshots', null=True, blank=True)
    ...
    data_json = models.JSONField(default=dict, blank=True, help_text=_('Additional analytics data'))
...
class UserProductivity(models.Model):
    ...
    """
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='productivity_metrics')
...
class TaskCompletionTime(models.Model):
    ...
    """
    task = models.OneToOneField(Task, on_delete=models.CASCADE, related_name='completion_time')
